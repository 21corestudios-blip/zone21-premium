...
export async function generateMetadata({
  ...
  const context = getProductionArtistStorefrontContext(artist, "loops");
...
export default async function ProductionArtistLoopsPage({ params }: PageProps) {
  const { artist } = await params;
  const context = getProductionArtistStorefrontContext(artist, "loops");
