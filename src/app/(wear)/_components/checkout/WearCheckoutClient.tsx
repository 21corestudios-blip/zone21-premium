    ...
    <section className="mx-auto w-full max-w-[1480px] bg-white px-6 pb-20 pt-28 md:px-12 md:pb-28 md:pt-36">
      <div className="border-b border-bg/10 pb-8">
        <nav className="flex items-center gap-3 font-sans text-[0.62rem] uppercase tracking-[0.24em] text-bg/42">
          <Link
            href="/wear"
            className="transition-colors duration-300 hover:text-bg"
          >
            CO-KAIN
          </Link>
          <span>/</span>
          ...
          <span>/</span>
          <span className="text-bg/70">Checkout</span>
        </nav>
      ...
      <div className="grid gap-12 pt-10 lg:grid-cols-[minmax(0,1.2fr)_380px] lg:items-start">
        <div className="space-y-10">
          <section className="border border-bg/10 bg-white p-6 md:p-8">
            <div className="mb-8">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              <label className="flex flex-col gap-3 md:col-span-2">
                <span className="font-sans text-[0.68rem] uppercase tracking-[0.2em] text-bg/55">
                  Nom complet
                </span>
                <input
                  required
                  ...
                  className="border border-bg/12 bg-white px-4 py-4 font-sans text-base text-bg outline-none transition-colors duration-300 placeholder:text-bg/30 focus:border-bg/35"
          ...
          <section className="border border-bg/10 bg-white p-6 md:p-8">
            ...
            {!isStripeConfigured() ? (
              <div className="border border-danger/18 bg-danger/4 px-5 py-4">
                <p className="font-sans text-sm font-light leading-relaxed text-danger-text">
              ...
              <div className="border border-bg/10 bg-white px-5 py-6">
                <p className="font-sans text-[0.68rem] uppercase tracking-[0.24em] text-bg/45">
                  Initialisation sécurisée du module de paiement...
                </p>
              </div>
            ) : (
              <>
                <p className="mb-6 max-w-2xl font-sans text-sm font-light leading-relaxed text-bg/65">
            ...
            {items.map((item) => (
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <h3 className="font-sans text-sm uppercase tracking-[0.18em] text-bg">
                      {item.product.name}
                    </h3>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="mt-2 font-sans text-sm font-light leading-relaxed text-bg/66">
                  ...
                  Stripe Elements, sans sortir de l’univers CO-KAIN.
                </p>
              </div>
