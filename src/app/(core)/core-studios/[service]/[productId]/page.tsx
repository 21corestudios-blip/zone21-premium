...
export async function generateMetadata({
  ...
  const { service, productId } = await params;
  const currentProduct = coreProducts.find(
    (product) => product.service === service && product.id === productId,
  );
...
export async function generateStaticParams() {
  return coreProducts.map((product) => ({
        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)] lg:gap-20">
          ...
          <div className="flex flex-col justify-center gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <p className="font-sans text-base font-light leading-relaxed text-[#121110]/72 md:text-lg">
                Chaque offre 21 Core Studios est pensée pour être activable,
