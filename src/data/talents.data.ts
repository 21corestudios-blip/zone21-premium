...
export const talentsData: TalentsData = {
  hero: {
    ...
    subtitle:
      "L'agence de promotion de talents et d'influence de ARCANE, dédiée aux profils qui construisent une présence forte sur les réseaux et au-delà.",
    image: "/images/brands/21-talents/z21-21-talents-agency-hero-1.webp",
  },
  manifesto: [
    "EKKO accompagne les talents, influenceurs et personnalités créatives dans la structuration de leur image publique, de leur présence éditoriale et de leurs opportunités de marque.",
