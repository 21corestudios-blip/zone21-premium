...
export const rdmRecords: RdmRecord[] = [
  {
    ...
    title:
      "Sources Projet - Cadre officiel des sources, directives et règles de cohérence ZONE 21",
    type: "DOC",
    status: "Validé",
    version: "v1.0",
    docxPath:
    ...
    normativeSources: ["Document-cadre suprême du système ZONE 21"],
  ...
  {
    id: "RDM-Z21-0010",
    reference: "DOC-Z21-SOCLE-PILOTAGE-GLOBAL-v1.0",
    title: "Socle Pilotage Global",
    type: "DOC",
    status: "Validé",
    version: "v1.0",
    docxPath:
